...
exports.PUSH_MESSAGE_STATUS = exports.WITHDRAWAL_REASONS = exports.SIGNUP_APPROVAL_STATUS_LABEL = exports.SIGNUP_APPROVAL_STATUS = void 0;
/**
 * TODO: 다른 도메인에서 아래 상태값들을 사용할 필요가 없는 경우,
 * 삭제가 필요합니다.
 * -> 로그인/회원가입/회원 정보 페이지 구현시 학인 예정입니다.
 */
exports.SIGNUP_APPROVAL_STATUS = {
    WAITING: 'waiting',
    REJECT: 'reject',
    BLACKLIST: 'blacklist',
};
 ...
 * -> 로그인/회원가입/회원 정보 페이지 구현시 학인 예정입니다.
 */
exports.SIGNUP_APPROVAL_STATUS_LABEL = {
    WAITING: '승인 대기',
    REJECT: '반려',
    BLACKLIST: '이용중지',
};
exports.WITHDRAWAL_REASONS = {
...
exports.PUSH_MESSAGE_STATUS = {
    SIGNAGE_AUTH_CODE_ARRIVE: 'SIGNAGE_AUTH_CODE_ARRIVE',
    SIGNAGE_AUTH_COMPLETE: 'SIGNAGE_AUTH_COMPLETE',
    NOTIFICATION_ARRIVE: 'NOTIFICATION_ARRIVE',
    NOTICE_ARRIVE: 'NOTICE_ARRIVE',
