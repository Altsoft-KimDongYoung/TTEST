...
export type FetchMyProfileResponse<T = MemberProfileDTO | BusinessMemberProfileDTO | ApartmentMemberProfileDTO | GVMTMemberProfileDTO | LocalNewspaperMemberProfileDTO> = T;
