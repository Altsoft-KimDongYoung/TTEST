import { NOTICE_MESSAGE_TYPE, NOTICE_MESSAGE_TYPE_LABEL, NOTIFICATION_BADGE_TYPE, NOTIFICATION_ICON_TYPE, NOTIFICATION_MESSAGE_TYPE } from '@/constants/news';
 ...
 * 내가 구독중인 로컬박스 조회
 * */
export interface NewsCommonResponse<T = NotificationContentDTO[] | NoticeContentDTO[] | BookmarkContentDTO[] | SubscriptionContentDTO[]> extends PagingInfo {
    content: T;
}
