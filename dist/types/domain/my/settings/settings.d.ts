...
export type SettingKey = 'isGlobalNotify' | 'isContentRegisterNotify' | 'isContentReplyLikeNotify' | 'isContentLikeNotify' | 'isContentReplyRegisterNotify' | 'isLocalboxSubscribeNotify' | 'isContentPosingNotify' | 'isContentBlindNotify';
/** @COMMON 알림설정 권한 DTO */
