...
/** @TYPE   */
export type LocalityComplainStatus = 'COMPLAIN_ACCEPT' | 'CONTENT_CLEAR' | 'CONTENT_BLIND' | 'CONTENT_BLIND_REQ_TO_CANCEL' | 'CONTENT_REJECT' | 'CONTENT_REJECT_REQ_TO_CANCEL' | 'CONTENT_BLIND_CANCELED';
